...
The project focuses on building essen al digital skills required for students, including the use of 
digital tools, coding, professional communica on, and cyber safety awareness. Each module is 
designed to provide prac cal knowledge and real-world applica on of digital literacy concepts.  
Module Summaries  
Module 1: Digital Literacy Infographic Created an infographic using Canva to explain: Digital 
...
Module 3: Coding & Google Form Solved a Python problem on HackerRank Created a Google 
Form for data collec on   
Folder: task-3-coding-googleform/  
Module 4: Email Wri ng & E que e Wrote a formal email Documented do’s and don’ts of 
email communica on   
Folder: task-4-email/  
